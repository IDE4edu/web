 ...
 *	jquery.ui.menu.js
 */
(function(e,t){e.widget("ui.selectmenu",{version:"@VERSION",defaultElement:"<select>",options:{appendTo:null,icons:{button:"ui-icon-triangle-1-s"},position:{my:"left top",at:"left bottom",collision:"none"},change:null,close:null,focus:null,open:null,select:null},_create:function(){var e=this.element.uniqueId().attr("id");this.ids={id:e,button:e+"-button",menu:e+"-menu"};this._drawButton();this._drawMenu();this._on(document,this._documentClick);if(this.options.disabled){this.disable()}},_drawButton:function(){var t=this.element.attr("tabindex");this.label=e("label[for='"+this.ids.id+"']").attr("for",this.ids.button);this._on(this.label,{click:function(e){this.button.focus();e.preventDefault()}});this.element.hide();this.button=e("<a>",{"class":"ui-button ui-widget ui-state-default ui-corner-all",href:"#"+this.ids.id,tabindex:t?t:this.options.disabled?-1:0,id:this.ids.button,width:this.element.outerWidth(),role:"combobox","aria-expanded":false,"aria-autocomplete":"list","aria-owns":this.ids.menu,"aria-haspopup":true});this.button.prepend(e("<span>",{"class":"ui-icon "+this.options.icons.button}));this.buttonText=e("<span>",{"class":"ui-selectmenu-text"}).appendTo(this.button);this._setText(this.buttonText,this.element.find("option:selected").text());this.buttonWrap=e("<span>",{"class":"ui-selectmenu-button"}).append(this.button).insertAfter(this.element);this._on(this.button,this._buttonEvents);this._hoverable(this.button);this._focusable(this.button)},_drawMenu:function(){var n,r=this;this.menu=e("<ul>",{"aria-hidden":true,"aria-labelledby":this.ids.button,id:this.ids.menu});this.menuWrap=e("<div>",{"class":"ui-selectmenu-menu",width:this.button.outerWidth()}).append(this.menu).appendTo(this._appendTo());n=this.menu.menu({select:function(e,t){var n=t.item.data("ui-selectmenu-item");r._select(n,e);if(r.isOpen){e.preventDefault();r.close(e)}},focus:function(e,n){var i=n.item.data("ui-selectmenu-item");if(r.focus!==t&&i.index!==r.focus){r._trigger("focus",e,{item:i});if(!r.isOpen){r._select(i,e)}}r.focus=i.index;r.button.attr("aria-activedescendant",r.menuItems.eq(i.index).find("a").attr("id"))},role:"listbox"}).data("ui-menu");this.menu.addClass("ui-corner-bottom").removeClass("ui-corner-all");n.delay=999999999;n._off(this.menu,"mouseleave")},refresh:function(){this.menu.empty();var e,t=this.element.find("option");if(t.length){this._readOptions(t);this._renderMenu(this.menu,this.items);this.menu.menu("refresh");this.menuItems=this.menu.find("li").not(".ui-selectmenu-optgroup");e=this._getSelectedItem();this.menu.menu("focus",null,e);this._setSelected(e.data("ui-selectmenu-item"));this._setOption("disabled",this._getCreateOptions().disabled)}},open:function(t){if(this.options.disabled){return}this.isOpen=true;this._toggleAttr();this.menuWrap.position(e.extend({of:this.button},this.options.position));this._trigger("open",t)},close:function(e){if(!this.isOpen){return}this.isOpen=false;this._toggleAttr();if(this.menuItems){var t=this._getSelectedItem().find("a").attr("id");this.button.attr("aria-activedescendant",t);this.menu.attr("aria-activedescendant",t)}this._trigger("close",e)},widget:function(){return this.button},menuWidget:function(){return this.menu},_renderMenu:function(t,n){var r=this,i="";e.each(n,function(n,s){if(s.optgroup!==i){e("<li>",{"class":"ui-selectmenu-optgroup"+(s.element.parent("optgroup").attr("disabled")?" ui-state-disabled":""),text:s.optgroup}).appendTo(t);i=s.optgroup}r._renderItem(t,s)})},_renderItem:function(t,n){var r=e("<li>").data("ui-selectmenu-item",n),i=e("<a>",{href:"#"});if(n.disabled){r.addClass("ui-state-disabled")}this._setText(i,n.label);return r.append(i).appendTo(t)},_setText:function(e,t){if(t){e.text(t)}else{e.html("&#160;")}},_move:function(e,t){if(e==="first"||e==="last"){this.menu.menu("focus",t,this.menuItems[e]())}else{this.menu.menu(e,t)}},_getSelectedItem:function(){return this.menuItems.eq(this.element[0].selectedIndex)},_toggle:function(e){if(this.isOpen){this.close(e)}else{this.open(e)}},_documentClick:{click:function(t){if(this.isOpen&&!e(t.target).closest("li.ui-state-disabled, li.ui-selectmenu-optgroup, #"+this.ids.button).length){this.close(t)}}},_buttonEvents:{focus:function(){this.refresh();this.button.addClass("ui-state-focus");this._off(this.button,"focus")},click:function(e){this._toggle(e);e.preventDefault()},keydown:function(t){var n=true;switch(t.keyCode){case e.ui.keyCode.TAB:case e.ui.keyCode.ESCAPE:if(this.isOpen){this.close(t)}n=false;break;case e.ui.keyCode.ENTER:if(this.isOpen){this.menu.menu("select",t)}break;case e.ui.keyCode.UP:if(t.altKey){this._toggle(t)}else{this._move("previous",t)}break;case e.ui.keyCode.DOWN:if(t.altKey){this._toggle(t)}else{this._move("next",t)}break;case e.ui.keyCode.SPACE:if(this.isOpen){this.menu.menu("select",t)}else{this._toggle(t)}break;case e.ui.keyCode.LEFT:this._move("previous",t);break;case e.ui.keyCode.RIGHT:this._move("next",t);break;case e.ui.keyCode.HOME:case e.ui.keyCode.PAGE_UP:this._move("first",t);break;case e.ui.keyCode.END:case e.ui.keyCode.PAGE_DOWN:this._move("last",t);break;default:this.menu.trigger(t);n=false}if(n){t.preventDefault()}}},_select:function(e,t){var n=this.element[0].selectedIndex;this.element[0].selectedIndex=e.index;this._setSelected(e);this._trigger("select",t,{item:e});if(e.index!==n){this._trigger("change",t,{item:e})}},_setSelected:function(e){this._setText(this.buttonText,e.label);this.menuItems.find("a").attr("aria-selected",false);this.menuItems.eq(e.index).find("a").attr("aria-selected",true);this.button.attr("aria-labelledby",this.menuItems.eq(e.index).find("a").attr("id"))},_setOption:function(e,t){if(e==="icons"){this.button.find("span.ui-icon").removeClass(this.options.icons.button).addClass(t.button)}this._super(e,t);if(e==="appendTo"){this.menuWrap.appendTo(this._appendTo())}if(e==="disabled"){this.menu.menu("option","disabled",t);if(t){this.element.attr("disabled","disabled");this.button.attr("tabindex",-1);this.close()}else{this.element.removeAttr("disabled");this.button.attr("tabindex",0)}}},_appendTo:function(){var t=this.options.appendTo;if(t){t=t.jquery||t.nodeType?e(t):this.document.find(t).eq(0)}if(!t){t=this.element.closest(".ui-front")}if(!t.length){t=this.document[0].body}return t},_toggleAttr:function(){this.button.toggleClass("ui-corner-top",this.isOpen).toggleClass("ui-corner-all",!this.isOpen);this.menuWrap.toggleClass("ui-selectmenu-open",this.isOpen);this.menu.attr("aria-hidden",!this.isOpen);this.button.attr("aria-expanded",this.isOpen)},_getCreateOptions:function(){return{disabled:!!this.element.attr("disabled")}},_readOptions:function(t){var n=[];t.each(function(t,r){var i=e(r),s=i.parent("optgroup");n.push({element:i,index:t,value:i.attr("value"),label:i.text(),optgroup:s.attr("label")||"",disabled:s.attr("disabled")||i.attr("disabled")})});this.items=n},_destroy:function(){this.menuWrap.remove();this.buttonWrap.remove();this.element.show();this.element.removeUniqueId();this.label.attr("for",this.ids.id)}})})(jQuery)

//used to notify scriptloader that this script has finished loading
if(typeof eventManager != 'undefined'){
	eventManager.fire('scriptLoaded', 'vle/jquery/js/jquery-ui-1.10.0.custom.min.js');
}