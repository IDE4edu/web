...
DATABASES = {
    'default': {
        ...
        'NAME': 'eduride',                      # Or path to database file if using sqlite3.
...
STATIC_ROOT = os.path.join(PROJECT_ROOT_DIR, 'static').replace('\\','/')
...
SECRET_KEY = 'k+$@p2by@mr27sm8jz2d@%b=4t=%8&i6v!1w_a!r85fbl0c5+l'
